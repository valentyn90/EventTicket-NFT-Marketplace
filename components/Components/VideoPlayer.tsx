...
export default function VideoPlayer({
  ...
  const safariSrc = `https://stream.mux.com/${src}/${max_resolution}.mp4`;
  ...
  useEffect(() => {
    ...
    if (video.canPlayType("application/vnd.apple.mpegurl")) {
      ...
      if(safariSrc != "https://stream.mux.com//.mp4") {video.src = safariSrc;}

    } else if (Hls.isSupported() && videoSrc != "https://stream.mux.com/.m3u8") {
