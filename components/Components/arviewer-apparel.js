        ...
        return (
            <>
                ...
                {this.state.appRendered &&
                    <a-scene mindar-image={"imageTargetSrc: "+this.props.target+";"} color-space="sRGB"
                        renderer="colorManagement: true, physicallyCorrectLights" vr-mode-ui="enabled: false"
                        device-orientation-permission-ui="enabled: false">
                        <a-assets>
                            <a-asset-item id="mask" src={this.props.mask}></a-asset-item>
                        ...
                        <a-entity mindar-image-target="targetIndex: 0"> 
                            <a-video src="#card-video" autoPlay webkit-playsinline="true" muted playsInline
                                loop={true} width={this.props.width} height={""+ this.props.height} position="0 0 0"></a-video>
                            <a-entity obj-model="obj: #mask;" rotation="0 -90 0" position="0 0 0.002" cloak></a-entity>
