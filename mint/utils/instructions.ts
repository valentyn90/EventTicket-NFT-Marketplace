...
export async function createConfigAccount(
  ...
  configData: { maxNumberOfLines: any; symbol?: string; sellerFeeBasisPoints?: number; isMutable?: boolean; maxSupply?: anchor.BN; retainAuthority?: boolean; creators?: { address: PublicKey; verified: boolean; share: number; }[]; },
